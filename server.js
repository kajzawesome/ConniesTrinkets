...
let items = [
  { id: 1, name: "Porcelain Teacup", desc: "From her 50th anniversary trip to England.", claimedBy: null },
  { id: 2, name: "Quilt Blanket", desc: "Handmade with love by Grandma.", claimedBy: null },
  { id: 3, name: "Photo Album", desc: "Family memories through the years.", claimedBy: null }
];
...
app.get("/market", (req, res) => {
  ...
  res.render("market", { items, user: req.session.username });
});
